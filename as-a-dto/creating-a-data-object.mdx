...
description: Learn how to create and initialize data objects using various methods including arrays, models, and magical creation methods.
---
...
### Requirements for Magical Methods
...
<Note>
This list can be extended using extra normalizers, find more about it [here](/advanced-usage/normalizers).
</Note>
...
<Note>
It is possible to configure how a data object is created, whether it will be validated, which casts to use and more. You can read more about it [here](/as-a-dto/factories).
</Note>

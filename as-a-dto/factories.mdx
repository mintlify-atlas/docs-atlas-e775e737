---
title: Factories
description: Customize data object creation with factories for advanced control over validation, casts, and property mapping.
---
...
We saw [earlier](/as-a-dto/mapping-property-names) that it is possible to map property names when creating a data object from an array. This can be disabled when using a factory:
...
A data object can be created using [magic methods](/as-a-dto/creating-a-data-object#magical-creation), this can be disabled when using a factory:
...
<Note>
You can read more about creation contexts [here](/advanced-usage/pipeline).
</Note>
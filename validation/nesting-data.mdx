---
title: Nesting Data
description: Learn how validation works with nested data objects and collections
---
...
Let's take a look again at the data object from the [nesting](/as-a-dto/nesting) section:
...
class AlbumData extends Data
{
    public function __construct(
        public string $title,
        public Optional|ArtistData $artist,
    ) {
    }
}
```

---
title: Casts
description: Transform data types using local and global casts for complex types like DateTime, Enums, and custom types.
---
...
<Tip>
We can also remove the `EnumCast` since the package will automatically cast enums because they're a native PHP type, but this made the example easy to understand.
</Tip>

## Creating Your Own Casts

It is possible to create your casts. You can read more about this in the [advanced chapter](/advanced-usage/creating-a-cast).

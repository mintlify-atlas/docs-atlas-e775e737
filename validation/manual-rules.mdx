---
title: Manual Rules
description: Define validation rules manually using the rules method on your data class
---
...
Always use the array syntax for defining rules and not a single string which splits the rules by `|` characters.
This is needed when using regexes since those `|` can be seen as part of the regex.
</Warning>

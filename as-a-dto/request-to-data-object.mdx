...
description: Create data objects from Laravel requests with automatic validation and dependency injection.
---
...
<Note>
We have a complete section within these docs dedicated to validation, you can find it [here](/validation/introduction).
</Note>

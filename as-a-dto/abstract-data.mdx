---
title: Abstract Data
description: Work with abstract data classes and polymorphic data objects using the morph method.
---
...
<Steps>
  ...
  <Step title="Mapped properties supported">
    Properties with mapped property names are still supported
  </Step>
</Steps>

## Abstract Data Classes as Collections
